...
def restaurant_ratings(restaurant):
    ...
    return [review_rating(x) for x in reviews ]
...
def restaurant_mean_rating(restaurant):
    ...
    total_rating = 0
    reviews_rating = restaurant_ratings(restaurant)
    for review in reviews_rating :
        total_rating = total_rating + review
    return total_rating / len(reviews_rating)
